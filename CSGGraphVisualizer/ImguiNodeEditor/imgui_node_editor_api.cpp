...
//void ax::NodeEditor::Suspend(bool keepsplitter)
//{
//    if (keepsplitter)
//        s_Editor->Suspend(ax::NodeEditor::Detail::SuspendFlags::KeepSplitter);
//    else
//        s_Editor->Suspend();
//}
//
//void ax::NodeEditor::Resume(bool keepsplitter)
//{
//    if (keepsplitter)    
//        s_Editor->Resume(ax::NodeEditor::Detail::SuspendFlags::KeepSplitter);
//    else
//        s_Editor->Resume();
//}
